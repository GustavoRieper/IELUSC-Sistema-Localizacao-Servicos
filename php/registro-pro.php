...
<!--        <script src='https://www.google.com/recaptcha/api.js'></script>-->
    ...
    <body>
        ...
        <div class="box_login">
            <form action="admin/cadastro-pro.php" id="login_box" autocomplete="off" method="post" onsubmit="return validarSenha();" name="cadastro">
                ...
                <span class="input input--hoshi">
                    <select name="profissoes" required>
                        ...
                        <?php
                            ...
                            while ($linha = mysqli_fetch_array($resultado)){
                                $nm_profissao = $linha["nm_profissao"];
                                echo("<option>$nm_profissao</option>");
