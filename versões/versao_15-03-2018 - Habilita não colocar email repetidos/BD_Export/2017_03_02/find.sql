...
--
-- Host: 127.0.0.1
-- Generation Time: 03-Mar-2018 às 01:53
...
INSERT INTO `usuario` (`cd_usuario`, `nm_usuario`, `senha_usuario`, `sm_usuario`, `email_usuario`, `dt_nascimento`, `cep_usuario`, `rua_usuario`, `bairo_usuario`, `cidade_usuario`, `estado_usuario`, `genero_usuario`) VALUES
...
--
ALTER TABLE `usuario`
  MODIFY `cd_usuario` int(11) NOT NULL AUTO_INCREMENT COMMENT 'codigo do usuario', AUTO_INCREMENT=2;
COMMIT;
