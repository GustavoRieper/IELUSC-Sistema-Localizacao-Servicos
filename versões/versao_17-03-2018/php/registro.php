    ...
    <body>
        ...
        <div class="box_login">
            <form action="admin/cadastro.php" id="login_box" autocomplete="off" method="post" onsubmit="return validarSenha();" name="cadastro">
                ...
                <span class="input input--hoshi">
                    <input id="cep" class="input__field input__field--hoshi" type="number" id="input-4" name="cep" required min="8" maxlength="8" />
                    <label class="input__label input__label--hoshi input__label--hoshi-color-1" for="input-4">
                        <span class="input__label-content input__label-content--hoshi">
                ...
                <span class="input input--hoshi">
                    <input id="rua" class="input__field input__field--hoshi" type="text" id="input-4" name="rua" required />
                    <label class="input__label input__label--hoshi input__label--hoshi-color-1" for="input-4">
                        <span class="input__label-content input__label-content--hoshi">
